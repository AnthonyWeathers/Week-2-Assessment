...
//CODE HERE
// console.log(deals[0].title) // shows 15% Off!
deals[0].title = deals[0].title.replace('15% Off!', '10% Off!')
console.log(deals[0].title) // shows 10% Off!
...
// console.log(deals[1].desc) // shows '   This deal lasts until the end of March! '
deals[1].desc = deals[1].desc.replace('   This deal lasts until the end of March! ', '   This deal lasts until the end of April! ')
console.log(deals[1].desc) // shows '   This deal lasts until the end of April! '